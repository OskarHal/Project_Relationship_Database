...
class CompanyCustomer(Base):
    ...
    customer_id = sa.Column(sa.Integer, sa.ForeignKey('customers.customer_id', ondelete='CASCADE', onupdate='CASCADE'),autoincrement=False, primary_key=True)
    company_customer_company_name = sa.Column(sa.String(100), nullable=False)
    ...
    def __repr__(self):
        return f'Customer ID={self.customer_id}, ' \
               f'Company Name={self.company_customer_company_name}, ' \
